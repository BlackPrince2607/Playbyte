...
export const type: Record<string, TextStyle> = {
  ...
  largeScore: { fontFamily: fonts.display, fontSize: 72, lineHeight: 72, fontWeight: "700" },
  stats: { fontFamily: fonts.mono, fontSize: 24, lineHeight: 34, fontWeight: "500" },
  statsSm: { fontFamily: fonts.mono, fontSize: 16, lineHeight: 22, fontWeight: "500" },
  bodyLg: { fontFamily: fonts.body, fontSize: 16, lineHeight: 24 },
  bodySm: { fontFamily: fonts.body, fontSize: 14, lineHeight: 21 },
  button: { fontFamily: fonts.bodyBold, fontSize: 16, lineHeight: 24, fontWeight: "700" },
